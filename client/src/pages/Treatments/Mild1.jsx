...
"/>
            <RightBox image={lionImage} heading="Mood and Symptom Tracking" text="Regular Input: Users are prompted to regularly input their mood, energy level, and other relevant symptoms, such as sleep quality and appetite changes. This can be done daily or as needed.
...
https://www.mind.org.uk/information-support/types-of-mental-health-problems/depression/self-care/"/>
            <LeftBox image={lionImage} heading="Self-Assessment" text="- Incorporate depression screening tools for users to assess the severity of their symptoms.- Offer personalized feedback based on assessment results."/>
            <RightBox image={lionImage} heading="Cognitive Behavioral Therapy (CBT)" text="- Integrate CBT exercises and modules to help users identify and challenge negative thought patterns.- Provide interactive tools for goal-setting and problem-solving."/>
