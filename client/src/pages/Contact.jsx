...
export default function ContactUs(){
    ...
    <div className='px-4 py-12 max-w-2xl mx-auto '>
      <h1 className='text-3xl font-bold text-white mb-4 text-slate-800'>
      Contact Us      
      </h1>
      <p className='mb-4 text-white text-slate-700'>
      ...
      <h1 className='text-3xl text-white font-bold  mb-4 text-slate-800'>
      Customer Support     
      </h1>
      <p className='mb-4 text-white text-slate-700'>
